...
public class AStarNode
{
    ...
    public void UpdatePassStatus(bool pass)
    {
        if (units.Count > 0)
        {
            walkable = pass;
            units[0].isPassable = pass;
            aStarCallback.InvokeHeuristic(this.aStarNodeParam);
        }
    }


    public void UpdatePassStatusEx(bool pass)
    {
        walkable = pass;
        units[0].isPassable = pass;
        aStarCallback.InvokeHeuristic(this.aStarNodeParam);
