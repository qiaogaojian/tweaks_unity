...
/// <summary> 
 ...
 { 
     ...
     public  Dictionary<string, AStarNode> nodes; 
     ...
     private IList<AStarNode> GMegadjacentNodes(AStarNode node)
     { 
     ...
     { 
         IList<AStarNode> adjacentNodes = this.GMegadjacentNodes(node);
         int cost = 0; 
     ...
     { 
         ...
         { 
             ...
             {
                 tmpNode = pathList[i];
                 pathList[i] = pathList[count - i-1];
                 pathList[count - i-1] = tmpNode;
             }
