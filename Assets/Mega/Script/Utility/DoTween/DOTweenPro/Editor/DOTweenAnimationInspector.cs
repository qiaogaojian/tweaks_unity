...
namespace DG.DOTweenEditor
{
    ...
    {
        enum FadMegargetType
        {
            CanvasGroup,
            Image
        }

        enum ChoosMegargetMode
        {
            None,
        ...
        ChoosMegargetMode _choosMegargetMode = ChoosMegargetMode.None;
...
//                _src.animationType = (DOTweenAnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
            ...
            if (prevAnimType != _src.animationType || ComponentsChanged()) {
                ...
                if (_src.animationType == DOTweenAnimationType.Fade && _src.GetComponent<CanvasGroup>() != null && _src.GetComponent<Image>() != null) {
                    _choosMegargetMode = ChoosMegargetMode.BetweenCanvasGroupAndImage;
                    ...
                    _choosMegargetMode = ChoosMegargetMode.None;
            ...
            if (_choosMegargetMode == ChoosMegargetMode.BetweenCanvasGroupAndImage && _src.forcedTargetType != TargetType.Unset) {
                FadMegargetType fadMegargetType = (FadMegargetType)Enum.Parse(typeof(FadMegargetType), _src.forcedTargetType.ToString());
                TargetType prevTargetType = _src.forcedTargetType;
                _src.forcedTargetType = (TargetType)Enum.Parse(typeof(TargetType), EditorGUILayout.EnumPopup(_src.animationType + " Target", fadMegargetType).ToString());
            ...
            case DOTweenAnimationType.LocalMove:
                ...
                canBeRelative = !_src.usMegargMegasV3;
                break;
            case DOTweenAnimationType.Rotate:
            case DOTweenAnimationType.LocalRotate:
        ...
        void GUIEndValueV3(bool optionalTransform = false)
        {
            ...
            if (optionalTransform) {
                if (GUILayout.Button(_src.usMegargMegasV3 ? "target" : "value", EditorGUIUtils.sideBtStyle, GUILayout.Width(44))) _src.usMegargMegasV3 = !_src.usMegargMegasV3;
            }
            GUILayout.EndHorizontal();
            if (_src.usMegargMegasV3 && _src.endValueTransform != null && _src.target is RectTransform) {
