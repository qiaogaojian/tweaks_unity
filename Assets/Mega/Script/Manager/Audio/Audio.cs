...
namespace Mega
{
    ...
    public class Audio
    {
        ...
        public Audio(AudioType audioType, AudioClip clip, bool loop, bool persist, float volume, float fadeInValue, float fadeOutValue, Transform sourceTransform)
        {
            ...
            Pitch     = 1;
            StereoPan = 0;
            if (sourceTransform != null && sourceTransform != Framework.Sound.Gameobject.transform)
            {
                SpatialBlend = 1;
            }
        ...
        public void Update()
        {
            ...
            switch (Type)
            {
                ...
                {
                    AudioSource.volume = Volume * Framework.Sound.GlobalMusicVolume * Framework.Sound.GlobalVolume;
                    break;
                }
                case AudioType.Sound:
                {
                    AudioSource.volume = Volume * Framework.Sound.GlobalSoundsVolume * Framework.Sound.GlobalVolume;
                    break;
                }
                case AudioType.UISound:
                {
                    AudioSource.volume = Volume * Framework.Sound.GlobalUISoundsVolume * Framework.Sound.GlobalVolume;
                    break;
                }
                case AudioType.BGM:
                {
