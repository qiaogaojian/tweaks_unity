...
public class TestSound : BaseView
{
    ...
    public override void InitView()
    {
        ...
        sliderGlobal  = transform.Find("sliderGlobal").GetComponent<Slider>();
        sliderMusic   = transform.Find("sliderMusic").GetComponent<Slider>();
        sliderSound   = transform.Find("sliderSound").GetComponent<Slider>();
        btnPause      = transform.Find("btnPause").GetComponent<Button>();
        btnMultiSound = transform.Find("btnMultiSound").GetComponent<Button>();
        btnStopSound  = transform.Find("btnStopSound").GetComponent<Button>();
        btnPauseMusic = transform.Find("btnPauseMusic").GetComponent<Button>();
        btnStopMusic  = transform.Find("btnStopMusic").GetComponent<Button>();
        btnMusic      = transform.Find("btnMusic").GetComponent<Button>();
        toggleSound   = transform.Find("toggleSound").GetComponent<Toggle>();
        toggleMusic   = transform.Find("toggleMusic").GetComponent<Toggle>();
        btnPlaySound1 = transform.Find("btnSound1").GetComponent<Button>();
        btnPlaySound2 = transform.Find("btnSound2").GetComponent<Button>();
        btnPlayMusic1 = transform.Find("btnMusic1").GetComponent<Button>();
        btnPlayMusic2 = transform.Find("btnMusic2").GetComponent<Button>();
